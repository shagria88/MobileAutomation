...
public class Sports extends Base {
    ...
    public void checkSports () throws InterruptedException {
        menu.click();
        sleep(2);
        sports.click();
        sleep(4);
        scrollAndClickByName("Giants want Eli Manning playing major role grooming successor");
        String Actual = ad.findElement(By.id("br.com.golmobile.nypost:id/title_text")).getText();
        String Expected = "Giants want Eli Manning playing major role grooming successor";
